...
# 宏基因组建库（KAPA Hyper Prep Kit）（试剂盒减半）
## 1、文库末端修复以及3＇端加A
（1）将End repair & A-Tailling Buffer和End repair & A-Tailling Enzyme Mix从-20℃冰箱取出，在冰上融化，并振荡混匀。转移混合均匀的DNA片段 30ng到PCR管中，加去离子水补足25μl(如果体积大于25μl需先纯化体系至25μl)，再分别加入3.5μL的End repair & A-Tailling Buffer和1.5μL的End repair & A-Tailling Enzyme Mix。
...
2、向上一步反应体系中加入3.75μL  PCR-grade water。

3、加入1.25μL  Index Adapter。

4、加入15μL  Ligation Buffer。
...
17、加入12.5μl Resuspension Buffer，用枪轻柔吸打10次混匀。（如有多个样品，要更换枪头）

18、盖上PCR管盖，室温孵育2min。

19、将PCR管置于磁力架上，室温孵育5min，可见珠子吸附成团，溶液将变透明。

20、转移10μl上清至新PCR管。（如有多个样品，要更换枪头）

## 3、文库PCR扩增
1、加入2.5μl 10×KAPA Library Amplification Primer Mix到含有接头连接产物的PCR管中。（如有多个样品，要更换枪头）

2、加入12.5μl 2×KAPA HiFi HotStart ReadyMix到含有接头连接产物的PCR管中。（如有多个样品，要更换枪头）
...
- VAHTSTM Universal DNA Library Prep Kit for Illumina® V2【ND606】：http://www.vazyme.com/downloadRepository/d12b8c79-0ef6-4026-97ca-5b746bf13e48.pdf
